...
#Description: This is a new, in progress version of the original version of the code for this project. Due to an unknown bug in
#the original, this version is going to be deconstructed piece by piece until the bug is found. A new version was created simply
...
#possible issues
#order of tasks might alter data
#algorithm bug in markov options
#algorithm bug in creating pssm from background probs
